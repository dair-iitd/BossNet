...
class BasicDecoder(Decoder):
  ...
  def __init__(self, 
    ...
    self._oov_ids = oov_ids
    self._oov_sizes = oov_sizes
  ...
  def _calc_final_dist(self, next_outputs, attn_dists, p_gens):
    ...
    with tf.variable_scope('final_distribution'):
      ...
      extra_zeros = tf.zeros((self.batch_size, max_oov_len))
      ...
      attention_ids = tf.reshape(self._oov_ids, [self.batch_size, -1])
